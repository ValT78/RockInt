...
public class QTEManager : MonoBehaviour
{
    ...
    [SerializeField] private int numSpawning = 20;
    ...
    {
        GameObject newUI = Instantiate(PickTouch(), new Vector3(1870, i*platformLenghtY+340, 0), Quaternion.identity, transform.Find("Line"));
    }
